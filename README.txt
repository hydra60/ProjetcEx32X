carpeta database contiene el script base para los problemas 6 y 5 
...
Nota: las soluciones al problema 1,2,3 se encuentran en las mismas rutas que muestran en las siguientes lineas

user estudiante: sam   ; pwd: sam
user docente:jp        ; pwd : juan123
